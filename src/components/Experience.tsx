...
const EXPERIENCES: ExperienceItem[] = [
  {
    ...
    highlights: [
      'Built the Demand Forecasting & Planning (DFP) product \u2014 Touchless Forecasting automating ~42% of the BMS portfolio for SKU-level planning and cutting forecasting effort ~35%',
    ...
    technologies: ['AERA', 'Python', 'SQL', 'SAP', 'AWS', 'React', 'FastAPI', 'Redshift', 'Decision Intelligence'],
  },
  {
    title: 'Data Scientist',
    ...
    highlights: [
      ...
      'Automated code documentation in a proof-of-concept with the Mistral LLM, reaching 95% accuracy',
    ],
